const translations = {
  en: {
    ...
    "range.tag.film.outcome": "c++ rendering engine — deployed in the hobbit, tintin, and rise of the planet of the apes",
    "range.tag.drone.label": "drone tech",
    "range.tag.drone.outcome": "real-time obstacle avoidance algorithm — reduced computation from hours to minutes",
    "range.tag.election.label": "election research",
    "range.tag.election.outcome": "real-time survey weighting and live election night forecasting system",
  ...
  de: {
    ...
    "range.tag.film.label": "film & vfx",
    "range.tag.film.outcome": "c++-rendering-engine — eingesetzt in the hobbit, tintin und rise of the planet of the apes",
    "range.tag.drone.label": "drohnen-tech",
    "range.tag.drone.outcome": "echtzeit-kollisionsvermeidungsalgorithmus — rechenzeit von stunden auf minuten reduziert",
    "range.tag.election.label": "wahlforschung",
    "range.tag.election.outcome": "echtzeit-umfragewichtung und live-wahlnacht-prognosesystem",
